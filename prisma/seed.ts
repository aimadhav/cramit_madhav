...
async function main() {
  ...
  const flashcards = [
    ...
    },
    {
      ...
      contentType: 'mixed',
      mediaUrlsJson: JSON.stringify(['https://upload.wikimedia.org/wikipedia/commons/thumb/d/d2/Pythagorean.svg/256px-Pythagorean.svg.png']),
    ...
    // Biology - Physiology
    {
      ...
      contentType: 'text',
      mediaUrlsJson: JSON.stringify(['https://upload.wikimedia.org/wikipedia/commons/thumb/e/e5/Heart_diagram-en.svg/300px-Heart_diagram-en.svg.png']),
    ...
    },
    {
      ...
      contentType: 'mixed',
      mediaUrlsJson: JSON.stringify(['https://upload.wikimedia.org/wikipedia/commons/thumb/4/4c/DNA_Structure%2BKey%2BLabelled.pn_NoBB.png/256px-DNA_Structure%2BKey%2BLabelled.pn_NoBB.png']),
